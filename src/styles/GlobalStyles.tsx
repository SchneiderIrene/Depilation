...
import AbrilFatfaceRegular from '/src/assets/fonts/AbrilFatface-Regular.woff2'
import LatoBold from '/src/assets/fonts/Lato-Bold.woff2'
  ...
  * {
  box-sizing: border-box;
   ...
   @font-face {
    ...
    src: url(${AbrilFatfaceRegular}) format('woff2');
    font-weight: 400;
    font-style: normal;
    font-display: swap;
  }
